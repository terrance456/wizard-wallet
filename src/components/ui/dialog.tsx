...
const DialogContent = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Content>, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { disableCloseBtn?: boolean }>(({ className, children, disableCloseBtn, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
